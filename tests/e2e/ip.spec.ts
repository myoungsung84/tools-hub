...
test.describe('/ip', () => {
  test('공인 IP 응답을 받아 위치와 네트워크 정보를 렌더링한다', async ({ page }, testInfo) => {
  ...
  test('사설 IP 응답에서는 로컬 환경 안내를 보여준다', async ({ page }, testInfo) => {
    setQaSummaryMetadata(testInfo, {
      parameters: {
        mockCase: 'private-ip',
        ip: '192.168.0.10',
